...
if __name__ == '__main__':
    ...
    # crf 转 rasa
    # transform_crf_platform(crf_path='task1_unlabeled_predict.txt', platform_path='submit12.json')

    # rasa 转 train
    # transform_platform_train(platform_path='submit12.json', train_path='submit12.txt')
